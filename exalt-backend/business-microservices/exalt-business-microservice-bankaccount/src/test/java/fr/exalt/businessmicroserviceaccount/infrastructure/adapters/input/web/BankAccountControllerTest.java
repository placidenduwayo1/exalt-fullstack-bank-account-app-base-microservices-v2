...
class BankAccountControllerTest {
    ...
    void createAccount(){
        ...
        //EXECUTE
        when(mock.createAccountKafkaEvent(dto1)).thenReturn(current);
        when(mock.createAccountKafkaEvent(dto2)).thenReturn(saving);
        BankAccount account1 = underTest.createAccount(dto1);
        BankAccount account2 = underTest.createAccount(dto2);

        //VERIFY
        assertAll("", () -> {
            verify(mock, atLeast(1)).createAccountKafkaEvent(dto1);
            verify(mock, atLeast(1)).createAccountKafkaEvent(dto2);
    ...
    void getAllAccounts() {
        ...
        ResponseEntity<Collection<BankAccount>> actual = underTest.getAllAccounts();
        //VERIFY
        assertAll("", () -> {
    ...
    void getAccountOfGivenCustomer() {
        ...
        ResponseEntity<Collection<BankAccount>> actual = underTest.getAccountOfGivenCustomer(customer.getCustomerId());
        //VERIFY
        assertAll("", () -> {
