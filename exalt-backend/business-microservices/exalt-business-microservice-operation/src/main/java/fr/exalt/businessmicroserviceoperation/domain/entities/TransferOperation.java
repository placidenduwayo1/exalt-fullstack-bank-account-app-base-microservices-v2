...
public class TransferOperation {
    ...
    private TransferOperation(TransferOperation.TransferBuilder builder){
    ...
    public static TransferOperation.TransferBuilder builder(){
        return new TransferOperation.TransferBuilder();
    }
